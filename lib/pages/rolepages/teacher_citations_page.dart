...
class TeacherCitationsPage extends StatelessWidget {
  final List<dynamic> aulas;

  const TeacherCitationsPage({super.key, required this.aulas});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: storageService.getClassroomCitations(aulas),
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(child: Text('No hay citaciones de aula por el momento.', style: TextStyle(
              color: Theme.of(context).colorScheme.primary
            ),));
          }
